...
export const RiskMeter: React.FC<RiskMeterProps> = ({ score }) => {
  ...
  let labelColor = 'bg-accent/30 text-accent border-accent/30';
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 bg-cyber-dark-bg border border-border rounded-xl shadow-inner select-none">
      ...
      <div className="mt-4 text-center">
        ...
        <span className="text-sm font-medium text-muted block mt-1">
