...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#050608] border-t border-border text-muted py-12 select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="hover:text-foreground transition"><Linkedin className="w-4 h-4" /></a>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-foreground font-mono text-sm font-semibold mb-4 tracking-wider uppercase">Platform</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/features" className="hover:text-foreground transition">Verify Features</Link></li>
              <li><Link to="/pricing" className="hover:text-foreground transition">Pricing Plans</Link></li>
              <li><Link to="/about" className="hover:text-foreground transition">About Us</Link></li>
              <li><Link to="/blog" className="hover:text-foreground transition">Flash Bulletin</Link></li>
            </ul>
          </div>

          {/* Legal / Resources */}
          <div>
            <h4 className="text-foreground font-mono text-sm font-semibold mb-4 tracking-wider uppercase">Resources & Privacy</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/help" className="hover:text-foreground transition">Help Centre</Link></li>
              <li><Link to="/contact" className="hover:text-foreground transition">Report Vulnerability</Link></li>
            </ul>
          </div>

          {/* Newsletter Signup */}
          <div className="space-y-4">
            <h4 className="text-foreground font-mono text-sm font-semibold tracking-wider uppercase">Cyber Intel Digest</h4>
            <p className="text-sm text-muted">
              Subscribe to receive updates on brand counterfeiting threats, scam domains, and digital commerce security warnings.
            </p>
            
            {subscribed ? (
              <div className="p-3 bg-accent/20 border border-accent/30 rounded text-xs text-accent">
              ...
              <form onSubmit={handleSubscribe} className="flex">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-xs bg-card border border-border rounded-l-md text-foreground focus:outline-none focus:border-accent focus:ring-1 focus:ring-cyber-blue-500"
                    required
                  />
                </div>
                <button
                  type="submit"
                  className="px-3 bg-accent hover:bg-accent text-foreground rounded-r-md transition"
                >
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 font-mono">
