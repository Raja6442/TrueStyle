...
import { ShieldCheck, Cpu, Database, Eye, Award, ShieldAlert, CheckCircle2 } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <h1 className="text-4xl font-bold text-foreground mt-2 tracking-tight">
          About True<span className="text-accent">Style</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        ...
        <GlassCard>
          <div className="flex items-center space-x-4 mb-4">
            ...
            <h3 className="text-xl font-bold text-foreground">Technology Paradigm</h3>
          </div>
          <p className="text-muted text-sm leading-relaxed">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-8 text-center font-mono">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <GlassCard key={idx} hoverable={true} className="flex flex-col items-center text-center">
            <div className="bg-cyber-dark-bg p-3 rounded-full mb-4 border border-border">
