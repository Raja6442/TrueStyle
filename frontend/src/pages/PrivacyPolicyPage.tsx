  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-muted text-xs font-mono">Effective Date: July 28, 2026</p>
      </div>
      ...
      <GlassCard hoverable={false} className="space-y-6 text-sm text-muted leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 pl-4 text-xs text-muted">
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-foreground flex items-center">
            <EyeOff className="w-5 h-5 text-accent mr-2" />
            3. Row-Level Database Security (RLS)
          </h2>
          <p>
            We implement strict Firebase Security Rules. This ensures that your scan logs and account configurations are only visible to you. Administrative accounts have restricted elevated rights audited in immutable ledger logs.
          </p>
        </section>
