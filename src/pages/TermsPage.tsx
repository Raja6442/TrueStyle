  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-gray-500 text-xs font-mono">Last Updated: July 28, 2026</p>
      </div>

      <GlassCard hoverable={false} className="space-y-6 text-sm text-gray-300 leading-relaxed">
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-white flex items-center">
            <Scale className="w-5 h-5 text-cyber-blue-500 mr-2" />
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-white flex items-center">
            <CheckCircle2 className="w-5 h-5 text-cyber-blue-500 mr-2" />
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-white flex items-center">
            <AlertTriangle className="w-5 h-5 text-cyber-blue-500 mr-2" />
